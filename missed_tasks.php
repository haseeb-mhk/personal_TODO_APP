  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark" ><span style="font-weight: bold;font-size: 40px">Missed Tasks</span> <span><sub><?php
		  ...
		  <div class="card card-outline card-danger collapsed-card">
              <div class="card-header">
                <h3 class="card-title" style="font-weight: bold">
					<a href="completed_task.php?SID=<?php echo $row['id'];?>" class="btn btn-tool" name="status" value=""> 
                ...
                <div class="card-tools">
					...
					<a href="missed_tasks.php?DID=<?php echo $row['id']?>" class="btn btn-tool" ><i class="fa fa-trash" style="color:red"></i>
                  </a>
