...
$select2 = mysqli_query($con, "select * from tasks  where due_date='$t_date' and status='$status2' order by priority ");
$select3 = mysqli_query($con, "select * from tasks where due_date<'$t_date' and status='$status2' order by priority");
//Deletion
if (!empty($_GET["DID"])) {
    $Did = $_GET["DID"];
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark" ><span style="font-weight: bold;font-size: 40px">Inbox</span> <span><sub><?php
		  ...
		  <div class="card card-outline card-warning collapsed-card">
              <div class="card-header">
                <h3 class="card-title" style="font-weight: bold">
					<a href="inbox.php?SID=<?php echo $row['id'];?>" class="btn btn-tool" name="status" value=""> 
                ...
                <div class="card-tools">
					...
					<a href="inbox.php?DID=<?php echo $row['id']?>" class="btn btn-tool" ><i class="fa fa-trash" style="color:red"></i>
                  </a>
...
<!--	  missed-->
	  <div class="container">
	  <div class="row">
		  <?php while ($row = mysqli_fetch_array($select3)) { 
